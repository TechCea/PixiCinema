...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/series-user.css') }}">
    ...
    <main>
        <div class="container">
            <div class="movie-main">
                ...
                <br> <br> <br>
                <p>En Jujutsu Kaisen, todos los seres vivos emanan una energía
                     llamada Energía Maldita, que brota de las emociones negativas 
                     que fluyen naturalmente por el cuerpo.</p>
            </div>
